...
public class Hood extends SubsystemBase {
  ...
  private final MotionMagicPIDPreferenceConstants hoodConfigConstants =
      new MotionMagicPIDPreferenceConstants("Hood/HoodMotor", 100., 250., 0., 0.5, 0., 0., 0.11, 0.2, 0.);
  private final DoublePreferenceConstant targetPos = new DoublePreferenceConstant("Hood/Target", 20.5);
